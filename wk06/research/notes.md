...
### Q1: Last time you used a task manager
**Response**: "it was for a group project. We had five tasks, and I had to check which ones were still assigned to me because the list was a mess. Every time I refreshed the page or switched to my phone, I lost the 'assigned to me' filter and had to re-apply it."

**Observations**:
- Mentioned filter UX issue (cognitive load)
- Context switching breaks workflow.
- Need to quickly isolate personal responsibility within a shared system
...
### Q2: What frustrates you?
**Response**: "Lag. If I mark something complete, I want that checkmark to appear instantly. If it takes three seconds, I tap it again, and then sometimes it unchecks itself because the system got confused. It wastes time."
